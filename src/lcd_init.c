...
void LCD_Init(void) {
  ...
  LCD_WR_REG(0xC0); LCD_WR_DATA8(0xAB); LCD_WR_DATA8(0x0B); LCD_WR_DATA8(0x04);
  LCD_WR_REG(0xC1); LCD_WR_DATA8(0xC5);
  LCD_WR_REG(0xC2); LCD_WR_DATA8(0x0D); LCD_WR_DATA8(0x00);
  LCD_WR_REG(0xC3); LCD_WR_DATA8(0x8D); LCD_WR_DATA8(0x6A);
  LCD_WR_REG(0xC4); LCD_WR_DATA8(0x8D); LCD_WR_DATA8(0xEE);
  LCD_WR_REG(0xC5); LCD_WR_DATA8(0x0F);

  LCD_WR_REG(0xE0); LCD_WR_DATA8(0x07); LCD_WR_DATA8(0x0E); LCD_WR_DATA8(0x08);
                   LCD_WR_DATA8(0x07); LCD_WR_DATA8(0x10); LCD_WR_DATA8(0x07);
                   LCD_WR_DATA8(0x02); LCD_WR_DATA8(0x07); LCD_WR_DATA8(0x09);
                   LCD_WR_DATA8(0x0F); LCD_WR_DATA8(0x25); LCD_WR_DATA8(0x36);
                   LCD_WR_DATA8(0x00); LCD_WR_DATA8(0x08); LCD_WR_DATA8(0x04);
                   LCD_WR_DATA8(0x10);
  LCD_WR_REG(0xE1); LCD_WR_DATA8(0x0A); LCD_WR_DATA8(0x0D); LCD_WR_DATA8(0x08);
                   LCD_WR_DATA8(0x07); LCD_WR_DATA8(0x0F); LCD_WR_DATA8(0x07);
                   LCD_WR_DATA8(0x02); LCD_WR_DATA8(0x07); LCD_WR_DATA8(0x09);
                   LCD_WR_DATA8(0x0F); LCD_WR_DATA8(0x25); LCD_WR_DATA8(0x35);
                   LCD_WR_DATA8(0x00); LCD_WR_DATA8(0x09); LCD_WR_DATA8(0x04);
                   LCD_WR_DATA8(0x10);

  LCD_WR_REG(0xFC); LCD_WR_DATA8(0x80);
  LCD_WR_REG(0x3A); LCD_WR_DATA8(0x05); /* RGB565 */

#if (USE_HORIZONTAL == 0)
  LCD_WR_REG(0x36); LCD_WR_DATA8(0x08);
#elif (USE_HORIZONTAL == 1)
  LCD_WR_REG(0x36); LCD_WR_DATA8(0xC8);
#elif (USE_HORIZONTAL == 2)
  LCD_WR_REG(0x36); LCD_WR_DATA8(0x78);
#else
  LCD_WR_REG(0x36); LCD_WR_DATA8(0xA8);
#endif

  LCD_WR_REG(0x21); /* Display inversion ON (IPS) */
  LCD_WR_REG(0x29); /* Display ON */

  LCD_WR_REG(0x2A); LCD_WR_DATA8(0x00); LCD_WR_DATA8(0x1A);
                   LCD_WR_DATA8(0x00); LCD_WR_DATA8(0x69);
  LCD_WR_REG(0x2B); LCD_WR_DATA8(0x00); LCD_WR_DATA8(0x01);
                   LCD_WR_DATA8(0x00); LCD_WR_DATA8(0xA0);
  LCD_WR_REG(0x2C);
}
